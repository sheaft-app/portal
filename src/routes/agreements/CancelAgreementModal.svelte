...
<ActionConfirm
	...
	<p class="leading-5">
		Vous vous apprêtez à révoquer votre
		accord  {authInstance.isInRole(Roles.Store.Value) ? agreement.delivery.producer.name : agreement.store.name}..
	</p>
