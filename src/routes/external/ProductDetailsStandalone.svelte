	...
	<div class="details-container">
		...
		{:else}
			<div class="mb-3 p-4 text-white bg-blue-500 rounded">
				<p>Vous pouvez partager ce lien sur votre site ou sur vos réseaux pour avoir une référence directe vers ce
					produit.</p>
		...
		{:else}
			...
			<div class="mt-5">
				<p class="mb-2">
					{#if product.rating}
						<p class="mb-0 text-xl"><span
							class="text-primary">★ </span>{product.rating} {product.ratingsCount > 0 ? `(${product.ratingsCount} avis)` : ''}
						</p>
					{:else}
