...
<div class="custom-number-input">
	...
	<div class="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1" class:opacity-50={disabled}>
		...
		<input
			...
			bind:value
			type="number"
			class="outline-none focus:outline-none text-center w-full bg-gray-300 font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-{color} outline-none"
