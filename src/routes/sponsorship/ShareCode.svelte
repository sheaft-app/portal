		...
		if (navigator.share) {
			navigator
				.share({
					...
					text: "Découvrez et commandez en quelques clics des produits de qualité issus de la production locale.",
					url: link,
				})
	...
	<div class="h-full">
		...
		{:else if code}
			<div class="text-center">
				<img src="/img/gift.svg" class="m-auto" style="width: 200px;" alt="Cadeaux !" />
				<p class="mt-5 font-semibold">Partagez ce code et gagnez des points pour chaque personne recrutée !</p>
				<div class="mt-6 mb-6">
					<span
            ...
            text-2xl bg-green-100"
				...
				{#if navigator.share}
					<button on:click={() => handleClick()} class="btn btn-primary btn-lg mt-3 m-auto">
              ...
              md:mb-0 md:mr-2"
				...
				<p class="text-gray-600 text-sm mt-3">
					Les points seront crédités sur votre compte lorsque la personne aura validé le code à l'inscription.
				</p>
			</div>
		{:else}
			<div>
