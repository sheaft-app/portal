...
<TransitionWrapper>
  <div
    ...
    <div class="flex flex-wrap lg:flex-no-wrap px-1">
      <div
        ...
        <div class="w-8/12 lg:w-full ml-3 lg:ml-0 lg:text-center">
          ...
          <p class="lg:mt-5 mt-2 lg:text-lg">
            Je veux trouver et commander les produits des producteurs autour de
            moi.
          </p>
        </div>
      ...
      <div
        on:click={() => routerInstance.goTo(RegisterRoutes.Owner, {
        ...
        <div class="w-8/12 lg:w-full ml-3 lg:ml-0 lg:text-center">
          ...
          <p class="lg:mt-5 mt-2 lg:text-lg">
            Je souhaite permettre à des consommateurs et à des commercants de me
            trouver et de commander mes produits.
          </p>
        </div>
        <div class="block lg:hidden w-1/12 flex items-center -my-2">
          <Icon data={faChevronRight} class="text-normal m-auto" />
      ...
      <div
        ...
        <div class="w-8/12 lg:w-full ml-3 lg:ml-0 lg:text-center">
          ...
          <p class="lg:mt-5 mt-2 lg:text-lg">
            Je possède un commerce ou un restaurant et souhaite passer des
            commandes régulièrement aux producteurs locaux.
          </p>
        </div>
        <div class="block lg:hidden w-1/12 flex items-center -my-2">
          <Icon data={faChevronRight} class="text-normal m-auto" />
