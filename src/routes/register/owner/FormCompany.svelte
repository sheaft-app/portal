<script>
  ...
  export let isStore = false, errorsHandler = null, siretWasNotFound = false;
    ...
    <div class="flex flex-wrap w-full shadow lg:rounded mb-5">
      ...
      <div class="px-5 py-3 bg-white lg:w-6/12 w-full">
        ...
        <div class="w-full form-control">
          ...
          <input name="line1" placeholder="ex : 210 Avenue de la Liberté" use:bindClass={{ form, name: "line1" }} bind:value={$company.address.line1} autocomplete="address-line1" />
          <ErrorContainer field={$form.fields.line1} />
        </div>
        <div class="w-full form-control">
          <label for="line2">Complément d'adresse</label>
          <input name="line2" placeholder="ex : Appartement 15" bind:value={$company.address.line2} autocomplete="address-line2" />
        </div>
        <div class="form-control">
          <div class="flex flex-wrap lg:flex-row lg:flex-no-wrap w-full">
            <div class="w-full pr-0 lg:pr-2">
              <label for="postcode">Code postal *</label>
              <input name="postcode" placeholder="ex : 74000" bind:value={$company.address.zipcode} use:bindClass={{ form, name: "zipcode" }} autocomplete="postal-code" />
              <ErrorContainer field={$form.fields.zipcode} />
            </div>
            <div class="w-full">
              <label for="city">Ville *</label>
              <input name="city" placeholder="ex : Annecy" bind:value={$company.address.city} use:bindClass={{ form, name: "city" }} autocomplete="address-level2" />
