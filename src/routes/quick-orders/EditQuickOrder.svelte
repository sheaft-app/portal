<script>
	...
	const handleSubmit = async () => {
		return await mutate({
			...
			successNotification: "Votre commande rapide a bien été mise à jour",
			errorNotification: "Impossible de mettre à jour votre commande rapide",
...
<TransitionWrapper>
	<PageHeader name="Editer un modèle de commande" previousPage={QuickOrderRoutes.List} />
