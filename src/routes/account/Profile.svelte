...
<TransitionWrapper classNames="m-auto">
	<section class="mb-4 pb-2 md:mb-6 md:pb-4 border-b border-gray-400 border-solid">
            ...
            background-position: center; width: 4em; height: 4em"
					...
					>
						<button
							...
							class="bottom-0 absolute text-xs text-white mt-6 shadow rounded-full bg-accent px-1"
							><Icon scale=".9" data={faEdit} /></button
						>
					</div>
				</div>
        ...
        hover:bg-gray-100"
			...
			{#if hasSentGPDRRequest}
				<p class="text-green-500 mt-1">
					Votre demande a bien été envoyée. Vous recevrez une copie de vos données par mail sous 48h.
				</p>
			{/if}
		</div>
		<hr class="mt-10 mb-5" />
