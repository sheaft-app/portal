...
>
	...
	<div class="form-control">
		...
		<div class="w-full md:w-2/2 flex justify-between">
			...
			<input bind:value={store.facebook} id="grid-line5" type="url" placeholder="Adresse vers votre page Facebook" />
		</div>
	</div>
	<div class="form-control">
		<div class="w-full md:w-2/2 flex justify-between">
			...
			<input bind:value={store.instagram} id="grid-line6" type="url" placeholder="Adresse vers votre page Instagram" />
		</div>
	</div>
	<div class="form-control">
		<div class="w-full md:w-2/2 flex justify-between">
