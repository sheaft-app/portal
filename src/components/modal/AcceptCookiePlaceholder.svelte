		...
		<div class="container m-auto">
			<div class="lg:w-8/12">
				...
				<p class="text-gray-600">
					Les cookies sont des données qui sont téléchargées ou stockées sur votre appareil. Nous les
					utilisons afin d’améliorer votre expérience sur notre site.
				</p>
				<p class="text-gray-600 mt-2">
					En cliquant sur ”J’accepte”, vous acceptez l’utilisation de ces cookies. Vous pourrez toujours les
					désactiver ultérieurement.
				</p>
			</div>
			<div class="flex flex-wrap lg:block mt-2 lg:w-3/12 w-full mx-auto">
				<button
					on:click={() => handleSubmit(true)}
					class="btn btn-primary btn-lg m-auto mb-2 w-full justify-center">Accepter les cookies</button
				>
				<button
