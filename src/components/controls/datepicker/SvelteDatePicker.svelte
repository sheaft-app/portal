...
export let monthsOfYear = [
  ...
  export let highlightColor = '#ff4081';
  export let dayBackgroundColor = '#efefef';
  export let dayTextColor = '#333';
  export let dayHighlightedBackgroundColor = '#ff4081';
  export let dayHighlightedTextColor = '#ffffff';
  ...
  >
    <div slot="trigger">
      <slot {selected} {formattedSelected}>
        {#if !trigger}
        <button class="scal-calendar-button" type="button">
          {formattedSelected}
        </button>
        {/if}
      </slot>
